...
(* OASIS_START *)
(* DO NOT EDIT (digest: 07f379733196932252a35c7870e21ce0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Arma\195\171l Gu\195\169neau <armael@isomorphis.me>"];
          homepage = None;
          synopsis = "Test Compositor for Wlc";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "wm.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\210\226P\206\153\165\019\219\234jx\156\168\144\190F";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
